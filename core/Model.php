...
class Model
{
    ...
    // Atributos que tendrán y necesitaran las clases hijas para poder hacer las consultas pertinentes a la base de datos 
    public function attributes()
    {
        return [];
    }

    // Reglas que tendrá cada atributo de attributes
